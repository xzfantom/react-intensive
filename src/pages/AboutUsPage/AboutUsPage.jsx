  ...
  return (
    <div className={s.wrap}>
      ...
      <div className={s.contentWrap}>
        ...
        <p className={s.description}>Do any of the following seem familiar?</p>
        <ul className={s.description}>
          <li>
            You often feel completely overwhelmed with the amount of work you’ve
            got to do?
          </li>
        ...
        <p className={s.description}>
          ...
          tasks in the list you plan the order in which you’re going to do them
          and can quickly see what needs your immediate attention and what tasks
          you can leave until a little later.
        </p>
      </div>
    </div>
  )
